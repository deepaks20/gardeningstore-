...
function Home() {
  ...
  return (
    <div>
       <div className='head'>
<h2><center>Green House</center></h2></div>
...
      </nav>
     ...
     <Link to='/Plants'>     <a href="#">Plants</a> </Link>
       <Link to='/seeds'>  <a href="#">Seeds</a></Link>
       <Link to='Fertilizers'>   <a href="#">Fertilizers</a></Link>
        <Link to='pesticide'>  <a href="#">Pesticides</a></Link>
         <Link to='gardendecor'> <a href="#">Garden Decor</a></Link>
          <a href="#">Offer</a>
        </nav>
